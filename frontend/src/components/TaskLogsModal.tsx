...
export default function TaskLogsModal({ taskId, title, timezone, onClose, bandwidth }: TaskLogsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-3xl h-[80vh] max-h-[calc(100vh-2rem)] max-w-[calc(100vw-2rem)] flex flex-col bg-zinc-950 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden animate-modal-in">
        {/* Modal Header */}

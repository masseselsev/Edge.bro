              ...
              {showProfile && (
                <div className="relative mr-1" ref={profileRef}>
                  ...
                  >
                    ...
                    <svg className={`w-3 h-3 text-zinc-500 transition-transform duration-200 ${profileOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">

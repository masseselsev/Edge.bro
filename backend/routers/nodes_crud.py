...
# Archive browsing — listing an archive's contents, previewing a file and
# downloading one — lives in routers/archives.py. Same URLs, still under
# /api/nodes/history/, because the frontend and every kiosk image already built
# point at them.
